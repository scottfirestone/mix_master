...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the artist as @artist and renders the show template" do
      artist = create(:artist)
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      it "updates the requested artist" do
        artist = create(:artist)
        put :update, {:id => artist.to_param, :artist => attributes_for(:artist, name: "updated_name")}
        artist.reload
        expect(artist.name).to eq("updated_name")
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the artist index" do
      artist = create(:artist)
      delete :destroy, {:id => artist.to_param}
